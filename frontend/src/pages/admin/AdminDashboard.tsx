                  ...
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((_, i) => (
                    <div key={i} className="flex items-center gap-4 py-2 border-b border-white/5 last:border-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium truncate">New instructor registration pending review</p>
                        <p className="text-[10px] text-slate-500">2 hours ago</p>
                      </div>
                      <button className="text-[10px] text-indigo-400 hover:underline shrink-0">View</button>
                    </div>
                  ))}
                </div>
              </div>
